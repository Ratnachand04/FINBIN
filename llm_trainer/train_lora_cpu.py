...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="CPU LoRA fine-tuning for Mistral in BINFIN stack")
    ...
    parser.add_argument("--adapter-name", default="binfin-mistral-lora-cpu")
